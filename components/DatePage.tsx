                ...
                <div className='space-y-4'>
                    <div className='flex space-x-2 items-center'>
                        ...
                        <div className='w-fit rounded-full bg-white py-4 px-1 text-2xl'>
                            <input placeholder='Select Date' type="text" className='placeholder:text-light-grey pl-12 focus:outline-none' />
                        </div>
                    </div>
                    <div className='flex space-x-2 items-center'>
                        <p className='text-light-text text-xl font-semibold whitespace-nowrap'>
                        ...
                        <div className='w-fit rounded-full bg-white py-4 px-1 text-2xl'>
                            <div className='flex items-center space-x-2'>
                                ...
                                <input placeholder='0' onChange={(e)=>{setCount(parseInt(e.target.value))}} type="text" className='placeholder:text-light-grey text-center focus:outline-none w-16 ' />
                                <button
                                onClick={()=>{
                                    setCount(count+1);
                                }}
