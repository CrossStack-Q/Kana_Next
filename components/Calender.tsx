...
const Calender: React.FC<MyCalenderProps> = ({ tabIndex }) => {
    return (
    <div>
<div className="flex items-center overflow-x-hidden justify-center py-8 px-4">

            <div className="max-w-xs rounded-md overflow-x-hidden w-full shadow-lg">
                <div className="md:px-4 overflow-x-hidden px-2 dark:bg-gray-800 bg-white rounded-t">
                    <div className="px-4 py-4 overflow-x-hidden flex items-center justify-between">
                        <span  tabIndex={tabIndex} className="focus:outline-none  text-base font-bold dark:text-gray-100 text-gray-800">October 2020</span>
                    ...
                    <div className="flex overflow-x-hidden items-center justify-between pt-4">
                                    ...
                                    <td>
                                        <div className="w-full h-full">
                                            <div className="flex items-center justify-center w-full rounded-full cursor-pointer">
                                                <a  role="link" tabIndex={tabIndex} className="focus:outline-none  focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 focus:bg-indigo-500 hover:bg-indigo-500 text-base w-8 h-8 flex items-center justify-center font-medium text-white bg-indigo-700 rounded-full">8</a>
                                            </div>
                                        </div>
                                    </td>
                                    <td>
